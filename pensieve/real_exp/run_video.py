...
# IMPORTANT SETUP STEPS that Allen followed to set this up:
# 0. run python setup.py from the pensieve root directory to get all dependencies
# 1. follow the steps here: https://towardsdatascience.com/how-to-setup-selenium-on-a-linux-vm-cd19ee47d922
# 	 to get selenium chrome webdriver to work on this vm
# 2. top solution found here: https://stackoverflow.com/questions/18429680/selenium-error-cannot-navigate-to-invalid-url
#    to fix the url error concerning driver.get()
...
#          |
#          v
url = 'localhost/' + 'myindex_' + abr_algo + '.html'   # localhost worked for me (Allen)
